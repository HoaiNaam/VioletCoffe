...
var possibleInput = { // Các câu trả lời của bot
  ...
  "liên hệ" : function(){
    ...
    responseText("Facebook: <a href='https://www.facebook.com/profile.php?id=100016255541020' target='_blank'>Nguyễn Hoài Nam</a>");
    responseText("Số điện thoại: 0583267059");
    responseText("email: <a href='mailto:hgooshvhd123@gmail.com?Subject=Xin chào Hoài Nam' target='_blank'> hgooshvhd123@gmail.com</a>");
    return
  },
  "yêu" : function(){
